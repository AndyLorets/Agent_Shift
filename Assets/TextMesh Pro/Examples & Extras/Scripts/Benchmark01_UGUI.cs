...
namespace TMPro.Examples
{
    ...
    public class Benchmark01_UGUI : MonoBehaviour
    {
        ...
        //private const string label01 = "TextMesh <#0050FF>Pro!</color>  The requiredCount is: {0}";
        //private const string label02 = "Text Mesh<color=#0050FF>        The requiredCount is: </color>";
